...
class V20220630004UpgradeTest(UpgradeStepIntegrationTest):
    """Test upgrade step from version 20220630004."""
...
class V20220630005UpgradeTest(UpgradeStepIntegrationTest):
    """Test upgrade step from version 20220630005."""
